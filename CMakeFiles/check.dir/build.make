...
CMakeFiles/check:
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --blue --bold --progress-dir=/Users/huangjunhao/go/src/code.onlearn.org/network/vsf/cs144/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Testing libsponge..."
	./tun.sh check 144 145
	./tap.sh check 10
	/usr/local/Cellar/cmake/3.22.1/bin/ctest --output-on-failure --timeout 10 -R '^t_|^arp_|^router_'
